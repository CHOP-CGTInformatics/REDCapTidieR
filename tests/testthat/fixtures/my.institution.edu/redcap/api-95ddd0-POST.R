structure(list(url = "https://my.institution.edu/redcap/api/", 
    status_code = 403L, headers = structure(list(date = "Tue, 03 Jan 2023 16:20:23 GMT", 
        ...
        `redcap-random-text` = "Zk2gKKxvWAWkY5KshuXJKKGLSidm", 
    ...
    "list")), all_headers = list(list(status = 403L, version = "HTTP/1.1", 
        headers = structure(list(date = "Tue, 03 Jan 2023 16:20:23 GMT", 
            server = "Apache", expires = "0", `cache-control` = "no-store, no-cache, must-revalidate", 
            pragma = "no-cache", `x-xss-protection` = "1;  mode=block", 
            `x-content-type-options` = "nosniff", `access-control-allow-origin` = "*", 
            `strict-transport-security` = "max-age=31536000; includeSubdomains;", 
    ...
    date = structure(1672762823, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 3e-05, 
    connect = 0.016358, pretransfer = 0.145244, starttransfer = 0.145247, 
    total = 0.640655)), class = "response")
