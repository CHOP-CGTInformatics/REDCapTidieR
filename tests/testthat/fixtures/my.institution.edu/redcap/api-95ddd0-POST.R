structure(list(url = "https://my.institution.edu/redcap/api/", 
    status_code = 403L, headers = structure(list(date = "Thu, 25 May 2023 19:12:38 GMT", 
        ...
        `redcap-random-text` = "MfdhZs6g3aYUIJBcUBZz9r2HiPr2C38MntL5pBmmZNjYxfoCvAreCHK", 
    ...
    "list")), all_headers = list(list(status = 403L, version = "HTTP/1.1", 
        headers = structure(list(date = "Thu, 25 May 2023 19:12:38 GMT", 
            server = "Apache", expires = "0", `cache-control` = "no-store, no-cache, must-revalidate", 
            pragma = "no-cache", `x-xss-protection` = "1;  mode=block", 
            `x-content-type-options` = "nosniff", `access-control-allow-origin` = "*", 
            `strict-transport-security` = "max-age=31536000; includeSubdomains;", 
    ...
    date = structure(1685041958, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.9e-05, 
    connect = 0.000896, pretransfer = 0.1213, starttransfer = 0.12131, 
    total = 0.78163)), class = "response")
