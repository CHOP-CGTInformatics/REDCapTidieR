structure(list(url = "https://my.institution.edu/redcap/api/", 
    status_code = 403L, headers = structure(list(date = "Mon, 13 Feb 2023 16:27:16 GMT", 
        ...
        `redcap-random-text` = "zuFTydEj7fatKMGunbvub9tYu6Wb4sD3vGWeebdF", 
    ...
    "list")), all_headers = list(list(status = 403L, version = "HTTP/1.1", 
        headers = structure(list(date = "Mon, 13 Feb 2023 16:27:16 GMT", 
            server = "Apache", expires = "0", `cache-control` = "no-store, no-cache, must-revalidate", 
            pragma = "no-cache", `x-xss-protection` = "1;  mode=block", 
            `x-content-type-options` = "nosniff", `access-control-allow-origin` = "*", 
            `strict-transport-security` = "max-age=31536000; includeSubdomains;", 
    ...
    date = structure(1676305636, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2e-05, 
    connect = 0.000778, pretransfer = 0.069613, starttransfer = 0.069617, 
    total = 0.502018)), class = "response")
