structure(list(url = "https://my.institution.edu/redcap/api/", 
    status_code = 403L, headers = structure(list(date = "Wed, 24 May 2023 18:31:58 GMT", 
        ...
        `redcap-random-text` = "6Ct8XWEVzFVawDXUGRm6eM3Svp9uKFTfeZ6a3J78GHovvCiiVA", 
    ...
    "list")), all_headers = list(list(status = 403L, version = "HTTP/1.1", 
        headers = structure(list(date = "Wed, 24 May 2023 18:31:58 GMT", 
            server = "Apache", expires = "0", `cache-control` = "no-store, no-cache, must-revalidate", 
            pragma = "no-cache", `x-xss-protection` = "1;  mode=block", 
            `x-content-type-options` = "nosniff", `access-control-allow-origin` = "*", 
            `strict-transport-security` = "max-age=31536000; includeSubdomains;", 
    ...
    date = structure(1684953118, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 1.9e-05, 
    connect = 0.00074, pretransfer = 0.188531, starttransfer = 0.188538, 
    total = 2.036406)), class = "response")
