structure(list(url = "https://my.institution.edu/redcap/api/", 
    status_code = 403L, headers = structure(list(date = "Thu, 30 Mar 2023 20:50:04 GMT", 
        ...
        `redcap-random-text` = "QmBD9NMZZvLjqVSQ7ImWmurBmvgX5rhDustTK9QsNFyJ3twcK", 
    ...
    "list")), all_headers = list(list(status = 403L, version = "HTTP/1.1", 
        headers = structure(list(date = "Thu, 30 Mar 2023 20:50:04 GMT", 
            server = "Apache", expires = "0", `cache-control` = "no-store, no-cache, must-revalidate", 
            pragma = "no-cache", `x-xss-protection` = "1;  mode=block", 
            `x-content-type-options` = "nosniff", `access-control-allow-origin` = "*", 
            `strict-transport-security` = "max-age=31536000; includeSubdomains;", 
    ...
    date = structure(1680209404, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.4e-05, 
    connect = 0.000804, pretransfer = 0.106547, starttransfer = 0.559057, 
    total = 0.559228)), class = "response")
