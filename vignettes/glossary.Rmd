...
|                                 |                                                                                               |
|                                 | Record ID [column](#columns) is the first column of a [data tibble](#data-tibble)             |
+---------------------------------+-----------------------------------------------------------------------------------------------+
...
|                                 |                                                                                               |
|                                 | (only present if the [project](#project) is [longitudinal](#longitudinal) with multiple arms) |
+---------------------------------+-----------------------------------------------------------------------------------------------+
