...
Here is a screenshot of the REDCap Status Dashboard of this database. Note that *Abin Sur* (record #2) has a single circle in the Super Hero Powers column, indiciating that they have one superpower. *Agent 13* (record #8) has no superpowers.
