...
|                          |                     |                          |                             | `redcap_arm`                |
+--------------------------+---------------------+--------------------------+-----------------------------+-----------------------------+
| **Repeating**            |  **Repeating**      |                                  Not Supported                                       |
+--------------------------+---------------------+--------------------------+-----------------------------+-----------------------------+
...
Note that both `physical_exam` and `hematology` are **nonrepeating** instruments. REDCapTidieR **only** allows nonrepeating instruments to occur in repeating events.
