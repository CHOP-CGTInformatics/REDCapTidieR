...
This makes it possible to discover all of the different options for a specific field even if not all of those options are represented in the data. For example, even though we have only Grade 1 and 2 adverse events in the database, we can see that there are 5 possible grades.
