...
creds <- REDCapTidieR:::get_credentials(
  c("REDCAP_URI", "SUPERHEROES_REDCAP_API", "REDCAPTIDIER_DEEP_DIVE_VIGNETTE_API", "REDCAPTIDIER_CLASSIC_API", "REDCAPTIDIER_DAG_API"),
  fake = fake
)
...
Some REDCap [projects](glossary.html#project) may use [Data Access Groups](glossary.html#data-access-group) (DAGs) to assign specific user privileges and record-level access to entries within the [project](glossary.html#project). [DAGs](glossary.html#data-access-group) are frequently used in mutli-center [projects](glossary.html#project) studies where centers need their data hidden from other participants.

[DAGs](glossary.html#data-access-group) are exported automatically, if available, after invoking `read_redcap()` and can be found as an additional [data column](glossary.html#data-column) called `redcap_data_access_group`.
