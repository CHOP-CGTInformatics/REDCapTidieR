...
You can see that the tibble that `import_redcap()` returned has only two rows. This may be surprising because you might expect more rows from a database with 734 superheroes. `import_redcap()` returns data in a special object that we call the **supertibble**. The supertibble contains, among other things, tibbles with the data and metadata derived from each instrument. We call these the **data tibbles** and **metadata tibbles**.
...
![Data Viewer showing the `superheroes` supertibble](https://github.com/CHOP-CGTInformatics/REDCapTidieR/blob/main/images/vignettes/viewer-supertibble.gif){width=75%}
...
![Data Viewer showing the `heroes_information` data tibble](https://github.com/CHOP-CGTInformatics/REDCapTidieR/blob/main/images/vignettes/viewer-heroes-information.gif){width=75%}
...
![Data Viewer showing the `super_hero_powers` data tibble](https://github.com/CHOP-CGTInformatics/REDCapTidieR/blob/main/images/vignettes/viewer-super-hero-powers.gif){width=75%}
...
![Data Viewer showing the `heroes_information` metadata tibble](https://github.com/CHOP-CGTInformatics/REDCapTidieR/blob/main/images/vignettes/viewer-metadata.gif){width=75%}
...
![Demonstration of the `bind_tibbles` function](https://github.com/CHOP-CGTInformatics/REDCapTidieR/blob/main/images/vignettes/bind-tibbles.gif){width=75%}
