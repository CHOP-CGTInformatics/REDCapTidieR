...
You might wonder if it's memory inefficient to have both the supertibble and the extracted tibbles in your environment. Because of R's copy-on-modify behavior this extracting data tibbles actually uses very little additional memory. Here is the size of the `superheroes` supertibble.
