...
library(dplyr)
# If creating mocks make sure REDCapTidieR is attached prior to any calls that
# need to be mocked. Otherwise our custom redactor won't be found when knitting
# TLDR: Don't move this library call
library(REDCapTidieR)

# If we're creating mocks we need to use the real tokens. Otherwise, use fakes.

# Check whether we're mocking
# start_vignette() starts mocking if the mock directory doesn't exist
# Checking this way is slightly hacky but httptest doesn't seem to expose
# anything that would allow an "official" check
mocking <- !dir.exists("REDCapTidieR")
