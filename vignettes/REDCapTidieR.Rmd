...
[REDCap](https://www.project-redcap.org/) is an electronic data capture software that is widely used in the academic research community. The [REDCapR](https://ouhscbbmc.github.io/REDCapR/) package streamlines calls to the REDCap API from an R environment. One of REDCapR's main uses is to [import](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#import) [records](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#record) from a REDCap [project](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#project). This works well for simple projects, however becomes [ugly](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/diving_deeper.html) when complex databases that include [longitudinal](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#longitudinal-project) structure and/or [repeating](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#repeating) instruments are involved.

The REDCapTidieR package aims to make the life of analysts who deal with complex REDCap databases easier. It builds upon **REDCapR** to make its output **tidier**. Instead of [one large data frame that contains all the data from your project](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#block-matrix), you get to work with a set of [tidy](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#tidy) [tibbles](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#tibble), one for each REDCap [instrument](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/glossary.html#instrument).
...
You might wonder if it's memory efficient to have both the supertibble and the extracted tibbles in your environment. Because of R's [copy-on-modify behavior](https://adv-r.hadley.nz/names-values.html#copy-on-modify), extracted data tibbles actually use very little additional memory. Here is the size of the `superheroes` supertibble.
