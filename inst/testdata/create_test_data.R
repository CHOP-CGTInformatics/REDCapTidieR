...
# Classic DB ----
db_data <- redcap_read_oneshot(redcap_uri = redcap_uri, token = classic_token, verbose = FALSE)$data

db_metadata <- redcap_metadata_read(redcap_uri = redcap_uri, token = classic_token, verbose = FALSE)$data %>%
...
db_data <- redcap_read_oneshot(redcap_uri = redcap_uri, token = classic_norepeat_token, verbose = FALSE)$data

db_metadata <- redcap_metadata_read(redcap_uri = redcap_uri, token = classic_norepeat_token, verbose = FALSE)$data
...
# Longitudinal DB ----
db_data_long <- redcap_read_oneshot(redcap_uri = redcap_uri, token = longitudinal_token, verbose = FALSE)$data

db_metadata_long <- redcap_metadata_read(redcap_uri = redcap_uri, token = longitudinal_token, verbose = FALSE)$data
...
db_data_long_norepeat <- redcap_read_oneshot(
  redcap_uri = redcap_uri,
  token = longitudinal_norepeat_token,
  verbose = FALSE
)$data

db_metadata_long_norepeat <- redcap_metadata_read(
  redcap_uri = redcap_uri,
  token = longitudinal_norepeat_token,
  verbose = FALSE
)$data
...
linked_arms_long <- link_arms(redcap_uri = redcap_uri, token = longitudinal_token)
...
linked_arms_long <- link_arms(redcap_uri = redcap_uri, token = longitudinal_norepeat_token)

saveRDS(linked_arms_long, "inst/testdata/linked_arms_long_norepeat.RDS")

# Longitudinal DB No Arms ----
db_data_long_noarms <- redcap_read_oneshot(redcap_uri = redcap_uri, token = longitudinal_noarms_token, verbose = FALSE)$data
...
linked_arms_long_noarms <- link_arms(redcap_uri = redcap_uri, token = longitudinal_noarms_token)
