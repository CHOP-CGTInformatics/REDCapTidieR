...
REDCapTidieR also supports exporting data directly to .xlsx documents. To showcase this, a practical demonstration is provided below:
...
For more information on how to work with and customize the output, read the [Exporting to Excel vignette](https://chop-cgtinformatics.github.io/REDCapTidieR/articles/export_to_xlsx.html) to learn more.
