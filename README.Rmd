...
REDCapTidieR is especially useful for dealing with complex databases that are longitudinal or include repeating instruments or both.
...
Use `import_redcap()` together with `bind_tibbles()` to import data from all instruments into your environment.

![Demonstration of using the `import_redcap` and `bind_tibbles` functions](man/figures/redcaptidier-demo.gif)

Read the [Getting Started vignette](articles/REDCapTidieR.html) to learn more.
