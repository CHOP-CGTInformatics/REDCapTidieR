...
![Demonstration of using the `read_redcap` and `bind_tibbles` functions](https://raw.githubusercontent.com/CHOP-CGTInformatics/REDCapTidieR/main/images/vignettes/redcaptidier-demo.gif)
